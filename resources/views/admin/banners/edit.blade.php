        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <form id="quickForm" action="{{route('bannersUpdate')}}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="page_name" class="form-control" value="{{$banners->page_name}}" id="page_name" requireplaceholder="Page Name">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
